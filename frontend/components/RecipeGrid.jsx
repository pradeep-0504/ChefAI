...
const RecipeGrid = ({
    type, //category or can be cuisine
    value,//actual category /cuisine name
    fetchAction,//server action to fetch recipes based on category/cuisine
    backLink="/dashboard"
}) => {
    ...
    const displayName=value?.replace(/-/g," ");//converts "any-name" like this to "any name"
  return (
    <div className='min-h-screen bg-stone-50 pt-14 px-4'>
        <div className='container mx-auto max-w-7xl'>
            <div className='mb-8'>
                ...
                {/* already fetched like loading false */}
                ...
                {loading && (
                    <div className='flex flex-col justify-center items-center py-20'>
                        <LoaderIcon className='w-10 h-10 text-orange-600 animate-spin mb-4'/>
